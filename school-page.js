(function () {
  if (!document.getElementById('_sp_css')) {
    ...
    css.textContent = [
      ...
      '.sr-mobile-bar{display:flex;align-items:stretch;gap:10px;overflow-x:auto;-webkit-overflow-scrolling:touch;scrollbar-width:none;margin:0 -16px 20px;padding:0 16px 4px;}',
